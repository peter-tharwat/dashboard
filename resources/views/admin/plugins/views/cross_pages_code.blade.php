            ...
            <div class="col-12 p-2">
                ...
                <div class="col-12 pt-3">
                   <div class="form-check form-switch">
                        ...
                        <a target="_blank" href="{{route('admin.plugins.builder-edit',['plugin'=>$plugin,'input_parameter'=>'top_navbar_code'])}}" class="btn btn-outline-primary font-1 px-3 pt-0 pb-1 rounded-0" >تعديل</a>
            ...
            <div class="col-12 p-2">
                ...
                <div class="col-12 pt-3">
                   <div class="form-check form-switch">
                        ...
                        <a target="_blank" href="{{route('admin.plugins.builder-edit',['plugin'=>$plugin,'input_parameter'=>'bottom_navbar_code'])}}" class="btn btn-outline-primary font-1 px-3 pt-0 pb-1 rounded-0" >تعديل</a>
            ...
            <div class="col-12 p-2">
                ...
                <div class="col-12 pt-3">
                   <div class="form-check form-switch">
                        ...
                        <a target="_blank" href="{{route('admin.plugins.builder-edit',['plugin'=>$plugin,'input_parameter'=>'top_footer_code'])}}" class="btn btn-outline-primary font-1 px-3 pt-0 pb-1 rounded-0" >تعديل</a>
            ...
            <div class="col-12 p-2">
                ...
                <div class="col-12 pt-3">
                   <div class="form-check form-switch">
                        ...
                        <a target="_blank" href="{{route('admin.plugins.builder-edit',['plugin'=>$plugin,'input_parameter'=>'bottom_footer_code'])}}" class="btn btn-outline-primary font-1 px-3 pt-0 pb-1 rounded-0" >تعديل</a>
