    ...
    <form method="POST" action="{{route('admin.plugins.update',['plugin'=>$plugin])}}">
        ...
        <div class="col-12 p-0">
            ...
            <div class="col-12 p-2">
                ...
                <div class="col-12 pt-3">
                    <input type="text" name="settings[PAYSKY_MID]" class="form-control" value="{{$plugin->settings['PAYSKY_MID']??""}}">
                </div>
            </div>
            ...
            <div class="col-12 p-2">
                ...
                <div class="col-12 pt-3">
                    <input type="text" name="settings[PAYSKY_TID]" class="form-control" value="{{$plugin->settings['PAYSKY_TID']??""}}">
                </div>
            </div>
            <div class="col-12 p-2">
                <div class="col-12">
                ...
                <div class="col-12 pt-3">
                    <input type="text" name="settings[PAYSKY_SECRET]" class="form-control" value="{{$plugin->settings['PAYSKY_SECRET']??""}}">
                </div>
            </div>
            <div class="col-12 p-2">
                <div class="col-12">
                ...
                <div class="col-12 pt-3">
                    <select class="form-control" name="settings[PAYSKY_MODE]">
                        <option value="live" {{($plugin->settings['PAYSKY_MODE']??"")=="live"?'selected':''}}>مباشر</option>
                        <option value="test" {{($plugin->settings['PAYSKY_MODE']??"")=="test"?'selected':''}}>تجريبي</option>
                    </select>
                </div>
            </div>
