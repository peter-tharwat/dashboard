                ...
                <div class="col-12 p-2">
                    ...
                    <div class="col-12 pt-3">
                       <textarea class="d-none" name="settings[component_content]">{{$plugin->settings['component_content']??''}}</textarea>
                        <a target="_blank" href="{{route('admin.plugins.builder-edit',['website_plugin'=>$plugin,'input_parameter'=>'component_content'])}}" class="btn btn-outline-primary font-1 px-3 pt-0 pb-1 rounded-0" >تعديل</a>
                    </div>
                </div>
