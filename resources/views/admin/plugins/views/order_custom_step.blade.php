    ...
    <form method="POST" action="{{route('admin.plugins.update',['plugin'=>$plugin])}}">
        ...
        <div class="col-12 p-0">
            ...
            <div class="col-12 p-2">
                <div class="col-12">
                    حالات الطلبات المخصصة
                </div>
                <div class="col-12 pt-3">
                    <textarea name="settings[custom_step]" class="form-control" style="min-height:250px;outline: none;" placeholder="قم بوضع كل حالة في سطر منفصل">{{$plugin->settings['custom_step']??""}}</textarea>
                </div>
            </div>
