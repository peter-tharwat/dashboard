		...
		<div class="col-12 px-0">
			<div class="col-12 p-0 row">
				<div class="col-12 col-lg-4 py-3 px-3">
					<span class="fas fa-comments"></span>  {{ __('lang.view_all') }}
				</div>
			...
			<table class="table table-bordered  table-hover">
				<thead>
					<tr>
						...
						<th style="width:130px;">{{ __('lang.user') }}</th>
						<th style="width:100px;">{{ __('lang.reviewed') }}</th>
						<th>{{ __('lang.content') }}</th>
						@if(auth()->user()->hasRole('superadmin'))
						<th>ip</th>
						@endif
						<th style="width:250px;">{{ __('lang.article') }}</th>
						<th style="width:170px;">{{ __('lang.control') }}</th>
					</tr>
				</thead>
