              ...
              <div class='main-content-of-block py-9 d-flex align-items-center justify-content-center ' style="z-index: 2;position: relative;min-height:{{$component['fields']['design_min_height']}}dvh">
                  <div class="container p-3">
                      ...
                      <div  class='col-12 mx-auto {{$component['fields']['design_text_alignment']}}'>
                          <h2 class='font-3 font-lg-4 mb-lg-3 mb-1 {{$component['fields']['design_text_alignment']}}' style="color:inherit;">{{$component['fields']['content_title']}}</h2>

                          <p class=' mb-3 mb-lg-5  font-1 font-lg-2 {{$component['fields']['design_text_alignment']}}' style="opacity: 0.9">{{$component['fields']['content_sub_title']}}</p>
                          <p class=' mb-3 mb-lg-5  font-1 font-lg-2 {{$component['fields']['design_text_alignment']}}' style="white-space: pre-line;opacity: 0.9">{{$component['fields']['content_description']}}</p>
                          <div class="col-12 px-0 d-flex btns-group {{$component['fields']['design_text_alignment']}}">
              ...
              <div class='main-content-of-block py-9 d-flex align-items-center justify-content-center ' style="z-index: 2;position: relative;min-height:{{$component['fields']['design_min_height']}}dvh">
                  <div class="container p-3">
                      ...
                      <div class='{{$component['fields']['design_text_alignment']}} {{$component['fields']['design_content_alignment']}} '>
                          <h2 class='font-3 font-lg-4  mb-lg-3 mb-1 {{$component['fields']['design_text_alignment']}}' style="color:inherit;">{{$component['fields']['content_title']}}</h2>
                          <p class=' mb-3 mb-lg-5  font-1 font-lg-2 {{$component['fields']['design_text_alignment']}}' style="opacity: 0.9;white-space: pre;">{{$component['fields']['content_description']}}</p>
              ...
              <div class='main-content-of-block py-9 d-flex align-items-center justify-content-center ' style="z-index: 2;position: relative;min-height:{{$component['fields']['design_min_height']}}dvh">
                  <div class="container p-3">
                      ...
                      <div class='{{$component['fields']['design_text_alignment']}}'>
                          <h2 class='font-3 font-lg-4  mb-lg-3 mb-1 {{$component['fields']['design_text_alignment']}}' style="color:inherit;">{{$component['fields']['content_title']}}</h2>
                          <p  class=' mb-3 mb-lg-5  font-1 font-lg-2 {{$component['fields']['design_text_alignment']}} ' style="opacity: 0.9;white-space:pre-line;">{{$component['fields']['content_sub_title']}}</p>
