                    ...
                    <form method="POST" action="{{ route('login') }}" class="row m-0">
                        ...
                        <div class="col-6 py-2 px-2">
                            <div class="col-12 p-0">
                                <a href="/login/google/redirect" style="border:2px solid #51c75b;color:inherit;box-shadow: 0px 6px 10px rgb(52 52 52 / 12%);" class="col-12 d-flex p-3 align-items-center justify-content-center btn">
                                   {{ __('lang.Sign') }} 
                                 <img src="/images/icons/google.png" style="width:30px" class="mx-2" />
                                </a>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="col-6 py-2 px-2">
                            <div class="col-12 p-0">
                                <a href="/login/facebook/redirect" style="border:2px solid #3f71cd;color:inherit;box-shadow: 0px 6px 10px rgb(52 52 52 / 12%);background: #3f71cd;color:#fff" class="col-12 d-flex p-3 align-items-center justify-content-center btn">
                                 ...
                                 <span class="fab fa-facebook-f mx-2" style="color:#fff"></span>
                                </a>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="col-12 px-4 py-2">
                            ...
                            <ul style="list-style:none;" class="p-0 m-0">
                                ...
                                <li class=" d-block"><a href="{{route('register')}}" class="naskh py-2 d-block" style="text-decoration: none!important;"><span class="fas fa-circle font-small" ></span> {{ __('lang.no_have_account') }} </a></li>
                                @endif
                                @if (Route::has('password.request'))
                                <li class="d-block"><a href="{{ route('password.request') }}" class="naskh py-2 d-block" style="text-decoration: none!important;"><span class="fas fa-circle font-small" ></span> {{ __('lang.forgot_password') }} </a></li>
                                @endif
                            </ul>
                        </div>
