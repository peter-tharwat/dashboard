            ...
            <div class="col-12 p-0" style="min-height: 80dvh;">
                <div class="col-12 p-0 row">
                    <div class="col-auto p-0 builder-aside" style="position:sticky;top: 0;width: 360px">
                        <div style="height:100dvh;overflow: auto;" class="p-3 col-12 add-component aside-wedgit">
                            ...
                            <div class="col-12 p-0">
                                            ...
                                            <div class="col-12 px-2 mb-3">
                                                <div v-if="(contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {}).content_image_url == null" class="col-12 p-0 row d-flex align-items-center">
                                                    <div style="width: 100px;padding: 0px;position: relative;height: 50px;overflow: hidden;background: #f1f1f1;cursor: pointer;" class="d-flex align-items-center justify-content-center">
                                                        ...
                                                        <input type="file" style="width:100%;opacity: 0;height: 100%;position: absolute;right: 0px;top: 0px;" @change="upload_image" :data-input="JSON.stringify(['contents',selected_page,selected_unique_id,selected_type,'content_image_url'])">
                                                    </div>
                                                            ...
                                                            <div :id="'collapse_'+ element.id" class="accordion-collapse collapse">
                                                                <div class="accordion-body px-2 py-3 row">
                                                                    ...
                                                                    <div class="col-6 px-0 my-1">
                                                                        ...
                                                                        <div class="col-12 px-2 mb-3">
                                                                            <select class="form-control" v-model="element.fields.open_type">
                                                                                <option value="">في نفس الصفحة</option>
                                                                                <option value="_blank">في صفحة أخرى</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-6 px-0 my-1">
                                                                    ...
                                                                    <div class="col-6 px-0 my-1">
                                                                        ...
                                                                        <div class="col-12 px-2 mb-3">
                                                                            <select class="form-control" v-model="element.fields.class">
                                                                                ...
                                                                                <option value="btn-info">رئيسي معلومة</option>
                                                                                ...
                                                                                <option value="btn-outline-info">رئيسي معلومة خارجي</option>
                                ...
                                <div v-if="('faqs' in (contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {}) )" class="col-12 px-0 my-2 py-2">
                                    ...
                                    <div class="col-12 px-2 mb-3 accordion">
                                        ...
                                        {{-- <div v-for="button,index in (contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {})['faqs']" :key="button">
                                            <div class="accordion-item mb-1">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button p-2" type="button" data-bs-toggle="collapse" :data-bs-target="'#collapse_'+ index" aria-expanded="true" :aria-controls="'#collapse_'+ index" style="font-size:13px">
                                                        <span class="fas fa-trash ms-2" v-on:click="(contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {}).faqs.splice(index,1)" style="color:#f44336"></span>
                                                        @{{(contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {})['faqs'][index].title}}
                                                    </button>
                                                </h2>
                                                <div :id="'collapse_'+ index" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body px-2 py-3 row">
                                                        <div class="col-12 px-0 my-1">
                                                            <div class="col-12 px-3 mb-2 font-1">
                                                                العنوان
                                                            ...
                                                            <div class="col-12 px-2 mb-3">
                                                                <input class="form-control" type="" name="" v-model="(contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {})['faqs'][index].title" style="font-size:14px;border-radius: 2px;">
                                                            </div>
                                                        </div>
                                                        <div class="col-12 px-0 my-1">
                                                            <div class="col-12 px-3 mb-2 font-1">
                                                            ...
                                                            <div class="col-12 px-2 mb-3">
                                                                <textarea class="form-control" v-model="(contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {})['faqs'][index].content" style="border-radius: 2px;min-height: 150px;"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <template #item="{ element }">
                                <div style="position:relative;" class="content-block" :class="'block_' + element.fields.id">
                                    ...
                                    <div class='position-relative  border-0 hoverable-elements-builder appened-element' :style="{'color': element.fields.design_text_color}">
                                        ...
                                        <div v-if="element.fields.block_type=='component_cta'" class='py-9 d-flex align-items-center justify-content-center ' style="z-index: 2;position: relative;" :style="{ 'min-height' : element.fields.design_min_height + 'dvh' }">
                                                ...
                                                <div :class="element.fields.design_text_alignment" class='col-12 col-lg-9 mx-auto '>
                                                    ...
                                                    <div class="col-12 p-0 d-flex btns-group" :class="element.fields.design_text_alignment">
                                                        <div v-for="button in element.fields['buttons']">
                                                            <a class="btn mx-1 font-1 font-lg-2 py-1 px-4 py-lg-2 px-lg-5" :class="button.fields.class" :target="button.fields.open_type" style="border-radius: 3px;">
                                                                @{{button.fields.title}}
                                                            </a>
                                                        </div>
                                                    </div>
                                        ...
                                        <div v-if="element.fields.block_type=='component_banner'" class='py-9 d-flex align-items-center justify-content-center ' style="z-index: 2;position: relative;" :style="{ 'min-height' : element.fields.design_min_height + 'dvh' }">
                                            <div class="container p-2">
                                                <div v-html="element.fields.design_custom_css"></div>
                                                <div :class="element.fields.design_text_alignment" class='col-12 col-lg-9 mx-auto '>
                                                    <h4 :class="element.fields.design_text_alignment" class='display-5 mb-3 ' style="color:inherit;">@{{element.fields.content_title}}</h4>
                                        ...
                                        <div v-if="element.fields.block_type=='component_text'" class='py-9 d-flex align-items-center justify-content-center' style="z-index: 2;position: relative;" :style="{ 'min-height' : element.fields.design_min_height + 'dvh' }">
                                            <div class="container p-2">
                                                <div v-html="element.fields.design_custom_css"></div>
                                                <div :class="element.fields.design_text_alignment" class='col-12 col-lg-9 mx-auto '>
                                                    <h4 :class="element.fields.design_text_alignment" class='display-5 mb-3 ' style="color:inherit;">@{{element.fields.content_title}}</h4>
                                        ...
                                        <div v-if="element.fields.block_type=='component_text_with_image'" class='py-9 d-flex align-items-center justify-content-center' style="z-index: 2;position: relative;" :style="{ 'min-height' : element.fields.design_min_height + 'dvh' }">
                                            <div class="container p-2">
                                                <div v-html="element.fields.design_custom_css"></div>
                                        ...
                                        <div v-if="element.fields.block_type=='component_text_with_video'" class='py-9 d-flex align-items-center justify-content-center' style="z-index: 2;position: relative;" :style="{ 'min-height' : element.fields.design_min_height + 'dvh' }">
                                            <div class="container p-2">
                                                <div v-html="element.fields.design_custom_css"></div>
                                                <div :class="[element.fields.design_text_alignment,element.fields.design_content_alignment]" class=' mx-auto row '>
                                                    <div class="col-12 col-lg-6 mx-auto">
                                        ...
                                        <div v-if="element.fields.block_type=='component_features'" :class="[element.fields.design_text_alignment,'block_' + element_slug]" class='py-9 d-flex align-items-center justify-content-center' style="z-index: 2;position: relative;" :style="{ 'min-height' : element.fields.design_min_height + 'dvh' }">
                                            <div class="container p-2">
                                                <div v-html="element.fields.design_custom_css"></div>
                                                <div :class="[element.fields.design_text_alignment,element.fields.design_content_alignment]" class=''>
                                                    ...
                                                    <div class="col-12 px-0 py-5 d-flex features-group row" :class="[element.fields.design_text_alignment,element.fields.design_content_alignment]">
                                                        <div v-for="feature in element.fields['features']" :class="element.fields.design_columns" class="p-3 mx-auto">
                                        ...
                                        <div v-if="element.fields.block_type=='component_faqs'" :class="[element.fields.design_text_alignment,'block_' + element_slug]" class='py-9 d-flex align-items-center justify-content-center' style="z-index: 2;position: relative;" :style="{ 'min-height' : element.fields.design_min_height + 'dvh' }">
                                            <div class="container p-2">
                                                <div v-html="element.fields.design_custom_css"></div>
                                        ...
                                        <div v-if="element.fields.block_type=='component_html'" class='py-9 d-flex align-items-center justify-content-center ' style="z-index: 2;position: relative;" :style="{ 'min-height' : element.fields.design_min_height + 'dvh' }">
                                            <div class="container p-2">
                                                <div v-html="element.fields.design_custom_css"></div>
