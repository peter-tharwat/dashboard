...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        toastr()->success(__('category_store_success_message'), __('successful_process_message'));
    ...
    public function update(Request $request, Category $category)
    {
        ...
        toastr()->success(__('category_update_success_message'), __('successful_process_message'));
        return redirect()->route('admin.categories.index');
    }
    ...
    public function destroy(Category $category)
    {
        ...
        $category->delete();
        toastr()->success(__('category_destroy_success_message'), __('successful_process_message'));
        return redirect()->route('admin.categories.index');
    }
}
